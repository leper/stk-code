...
class GrassSubsurfaceScatteringShader : public ShaderHelperSingleton<GrassSubsurfaceScatteringShader, core::matrix4, core::matrix4, core::vector3df, core::vector3df>, public TextureRead<Nearest_Filtered, Trilinear_Anisotropic_Filtered>
{
public:
    GrassSubsurfaceScatteringShader();
};

class InstancedGrassSubsurfaceScatteringShader : public ShaderHelperSingleton<InstancedGrassSubsurfaceScatteringShader, core::vector3df, core::vector3df>, public TextureRead<Nearest_Filtered, Trilinear_Anisotropic_Filtered>
{
public:
    InstancedGrassSubsurfaceScatteringShader();
};
...
class IBLShader : public ShaderHelperSingleton<IBLShader, core::matrix4, std::vector<float>, std::vector<float>, std::vector<float> >, public TextureRead<Nearest_Filtered, Nearest_Filtered, Nearest_Filtered, Nearest_Filtered, Trilinear_cubemap, Bilinear_Clamped_Filtered>
{
public:
    IBLShader();
};

class ShadowedSunLightShader : public ShaderHelperSingleton<ShadowedSunLightShader, float, float, float, float, core::vector3df, video::SColorf>, public TextureRead<Nearest_Filtered, Nearest_Filtered, Nearest_Filtered, Shadow_Sampler>
{
public:
