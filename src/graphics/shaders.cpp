...
namespace MeshShader
{
    ...
    GrassSubsurfaceScatteringShader::GrassSubsurfaceScatteringShader()
    {
        Program = LoadProgram(OBJECT,
            GL_VERTEX_SHADER, file_manager->getAsset("shaders/grass_pass.vert").c_str(),
            GL_FRAGMENT_SHADER, file_manager->getAsset("shaders/utils/getLightFactor.frag").c_str(),
            GL_FRAGMENT_SHADER, file_manager->getAsset("shaders/grass_pass2.frag").c_str());
        AssignUniforms("ModelMatrix", "InverseModelMatrix", "windDir", "Sundir");
        AssignSamplerNames(Program, 0, "dtex", 1, "Albedo");
    }

    InstancedGrassSubsurfaceScatteringShader::InstancedGrassSubsurfaceScatteringShader()
    {
        Program = LoadProgram(OBJECT,
            GL_VERTEX_SHADER, file_manager->getAsset("shaders/utils/getworldmatrix.vert").c_str(),
            GL_VERTEX_SHADER, file_manager->getAsset("shaders/instanced_grass.vert").c_str(),
